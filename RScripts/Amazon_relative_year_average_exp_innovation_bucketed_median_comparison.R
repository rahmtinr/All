...
draw_all <- function() {
    ...
    return
    draw_relative_year_comparison("Music", "final", "0.05", )
    draw_relative_year_comparison("Music", "final", "3.8", )
    draw_relative_year_comparison("Music", "current", "0.05", )
    draw_relative_year_comparison("Music", "current", "3.8", )

    draw_relative_year_comparison("Movies_and_TV", "final", "0.05", )
    draw_relative_year_comparison("Movies_and_TV", "final", "9.0", )
    draw_relative_year_comparison("Movies_and_TV", "final", "12", )
    draw_relative_year_comparison("Movies_and_TV", "current", "0.05", )
    draw_relative_year_comparison("Movies_and_TV", "current", "9.0", )
    draw_relative_year_comparison("Movies_and_TV", "current", "12", )

    draw_relative_year_comparison("Books", "final", "0.05", )
    draw_relative_year_comparison("Books", "final", "9.0", )
    draw_relative_year_comparison("Books", "final", "12", )
    draw_relative_year_comparison("Books", "current", "0.05", )
    draw_relative_year_comparison("Books", "current", "9.0", )
    draw_relative_year_comparison("Books", "current", "12", )

    draw_relative_year_comparison("Electronics", "final", "0.05", )
    draw_relative_year_comparison("Electronics", "final", "12", )
    draw_relative_year_comparison("Electronics", "current", "0.05", )
    draw_relative_year_comparison("Electronics", "current", "12", )

    draw_relative_year_comparison("Beer_Advocate", "final", "0.05", )
    draw_relative_year_comparison("Beer_Advocate", "final", "4.2", )
    draw_relative_year_comparison("Beer_Advocate", "final", "12", )
    draw_relative_year_comparison("Beer_Advocate", "current", "0.05", )
    draw_relative_year_comparison("Beer_Advocate", "current", "4.2", )
    draw_relative_year_comparison("Beer_Advocate", "current", "12", )

    draw_relative_year_comparison("Rate_Beer", "final", "0.05", )
    draw_relative_year_comparison("Rate_Beer", "final", "6.0", )
    draw_relative_year_comparison("Rate_Beer", "final", "12", )
    draw_relative_year_comparison("Rate_Beer", "current", "0.05", )
    draw_relative_year_comparison("Rate_Beer", "current", "6.0", )
    draw_relative_year_comparison("Rate_Beer", "current", "12", )

    draw_relative_year_comparison("reddit_funny", "final", "0.05", "30000")
    draw_relative_year_comparison("reddit_funny", "final", "3.6", )
    draw_relative_year_comparison("reddit_funny", "final", "4.5", )
    draw_relative_year_comparison("reddit_funny", "current", "0.05", "30000" )
    draw_relative_year_comparison("reddit_funny", "current", "3.6", )
    draw_relative_year_comparison("reddit_funny", "current", "4.5", )

    draw_relative_year_comparison("reddit_AskReddit", "final", "0.05", )
    draw_relative_year_comparison("reddit_AskReddit", "final", "9.0", )
    draw_relative_year_comparison("reddit_AskReddit", "final", "12", )
    draw_relative_year_comparison("reddit_AskReddit", "current", "0.05", )
    draw_relative_year_comparison("reddit_AskReddit", "current", "9.0", )
    draw_relative_year_comparison("reddit_AskReddit", "current", "12", )
    
    draw_relative_year_comparison("reddit_pics", "final", "0.05", )
    draw_relative_year_comparison("reddit_pics", "final", "2.6", )
    draw_relative_year_comparison("reddit_pics", "final", "4.5", )
    draw_relative_year_comparison("reddit_pics", "current", "0.05", )
    draw_relative_year_comparison("reddit_pics", "current", "2.6", )
    draw_relative_year_comparison("reddit_pics", "current", "4.5", )

    draw_relative_year_comparison("reddit_AdviceAnimals", "final", "0.05", )
    draw_relative_year_comparison("reddit_AdviceAnimals", "final", "4.5", )
    draw_relative_year_comparison("reddit_AdviceAnimals", "final", "6.0", )
    draw_relative_year_comparison("reddit_AdviceAnimals", "current", "0.05", )
    draw_relative_year_comparison("reddit_AdviceAnimals", "current", "4.5", )
    draw_relative_year_comparison("reddit_AdviceAnimals", "current", "6.0", )
    
    draw_relative_year_comparison("reddit_gaming", "final", "0.05", )
    draw_relative_year_comparison("reddit_gaming", "final", "4.5", )
    draw_relative_year_comparison("reddit_gaming", "final", "6.0", )
    draw_relative_year_comparison("reddit_gaming", "current", "0.05", )
    draw_relative_year_comparison("reddit_gaming", "current", "4.5", )
    draw_relative_year_comparison("reddit_gaming", "current", "6.0", )

    draw_relative_year_comparison("reddit_videos", "final", "0.05", )
    draw_relative_year_comparison("reddit_videos", "final", "3.6", )
    draw_relative_year_comparison("reddit_videos", "current", "0.05", )
    draw_relative_year_comparison("reddit_videos", "current", "3.6", )

    draw_relative_year_comparison("reddit_politics", "final", "0.05", )
    draw_relative_year_comparison("reddit_politics", "final", "2.6", )
    draw_relative_year_comparison("reddit_politics", "final", "9.0", )
    draw_relative_year_comparison("reddit_politics", "current", "0.05", )
    draw_relative_year_comparison("reddit_politics", "current", "2.6", )
    draw_relative_year_comparison("reddit_politics", "current", "9.0", )
    
    draw_relative_year_comparison("reddit_trees", "final", "0.05", )
    draw_relative_year_comparison("reddit_trees", "final", "4.5", )
    draw_relative_year_comparison("reddit_trees", "final", "6.0", )
    draw_relative_year_comparison("reddit_trees", "current", "0.05", )
    draw_relative_year_comparison("reddit_trees", "current", "4.5", )
    draw_relative_year_comparison("reddit_trees", "current", "6.0", )

    draw_relative_year_comparison("reddit_WTF", "final", "0.05", )
    draw_relative_year_comparison("reddit_WTF", "final", "6.0", )
    draw_relative_year_comparison("reddit_WTF", "current", "0.05", )
    draw_relative_year_comparison("reddit_WTF", "current", "6.0", )
    
    draw_relative_year_comparison("reddit_aww", "final", "0.05", )
    draw_relative_year_comparison("reddit_aww", "final", "4.0", )
    draw_relative_year_comparison("reddit_aww", "current", "0.05", )
    draw_relative_year_comparison("reddit_aww", "current", "4.0", )

    draw_relative_year_comparison("reddit_fffffffuuuuuuuuuuuu", "final", "0.05", )
    draw_relative_year_comparison("reddit_fffffffuuuuuuuuuuuu", "final", "3.4", )
    draw_relative_year_comparison("reddit_fffffffuuuuuuuuuuuu", "current", "0.05", )
    draw_relative_year_comparison("reddit_fffffffuuuuuuuuuuuu", "current", "3.4", )

    draw_relative_year_comparison("reddit_Music", "final", "0.05", )
    draw_relative_year_comparison("reddit_Music", "final", "3.8", )
    draw_relative_year_comparison("reddit_Music", "current", "0.05", )
    draw_relative_year_comparison("reddit_Music", "current", "3.8", )
    
    draw_relative_year_comparison("reddit_worldnews", "final", "0.05", )
    draw_relative_year_comparison("reddit_worldnews", "final", "6.0", )
    draw_relative_year_comparison("reddit_worldnews", "current", "0.05", )
    draw_relative_year_comparison("reddit_worldnews", "current", "6.0", )
    
    draw_relative_year_comparison("reddit_leagueoflegends", "final", "0.05", )
    draw_relative_year_comparison("reddit_leagueoflegends", "final", "4.0", )
    draw_relative_year_comparison("reddit_leagueoflegends", "final", "9.0", )
    draw_relative_year_comparison("reddit_leagueoflegends", "current", "0.05", )
    draw_relative_year_comparison("reddit_leagueoflegends", "current", "4.0", )
    draw_relative_year_comparison("reddit_leagueoflegends", "current", "9.0", )

    draw_relative_year_comparison("reddit_technology", "final", "0.05", )
    draw_relative_year_comparison("reddit_technology", "final", "12", )
    draw_relative_year_comparison("reddit_technology", "current", "0.05", )
    draw_relative_year_comparison("reddit_technology", "current", "12", )
}
