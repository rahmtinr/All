...
jpeg(paste(directory,"AggregationPlots/", dataset, "_distribution_ending_experience_level_linear_linear.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/", dataset, "_distribution_present_experience_level_linear_linear.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/", dataset, "_distribution_ending_experience_level_log_linear.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/", dataset, "_distribution_present_experience_level_log_linear.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/", dataset, "_distribution_ending_experience_level_log_log.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/", dataset, "_distribution_present_experience_level_log_log.jpg",sep=""))
