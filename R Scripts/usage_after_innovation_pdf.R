...
jpeg(paste(directory,"AggregationPlots/pdf_after_innovation_linear_linear.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/pdf_after_innovation_log_log.jpg",sep=""))
...
jpeg(paste(directory,"AggregationPlots/pdf_after_innovation_log_linear.jpg",sep=""))
