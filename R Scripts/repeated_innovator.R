...
innovator_distribution = read.table(paste(directory,"innovation_for_each_user.txt", sep=""), header=FALSE)
...
jpeg(paste(directory,"AggregationPlots/reinvention.jpg",sep=""))
