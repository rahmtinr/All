...
StateMachineCoeff=("2.0" "2.2" "2.4" "2.6" "2.8" "3.0")
...
#                    ./dblpFindInnovation $input $burst_mode $StateMachine $state_machine_coeff #always real time
                    echo "Done with finding innovations, Starting Analysis ..." 
                   ./dblpAnalysis $input $burst_mode $StateMachine $experience_state $state_machine_coeff #always real time
